...
class SGGNN_Note(nn.Module):
    def __init__(self, network_parameters, device):
        ...
        self.final_graph_input_size = self.final_input + self.encoder_size + self.output_size + self.final_graph_margin_size
    ...
    def forward(self, x, y, edges, note_locations, start_index, initial_z=False, return_z=False):
        ...
        out_with_result = torch.cat((note_out, graph_out, measure_perform_style_spanned, initial_output, initial_margin), 2)
