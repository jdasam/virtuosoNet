...
# data_set = xml_matching.DataSet('MIDI_XML_sarah/')
# data_set._load_all_performances()
# data_set._extract_all_features()
...
#
#
target_features = ['attack_deviation', 'abs_deviation', 'tempo_fluctuation', 'left_hand_velocity', 'right_hand_velocity', 'velocity']
