...
chopin_pairs, num_train_pairs = xml_matching.load_entire_subfolder('chopin_cleaned/Liszt/Sonata')
save_features_as_vector(chopin_pairs, num_train_pairs, 'graph_liszt_sonata')