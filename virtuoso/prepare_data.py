...
emotion_dataset = data_class.EmotionDataset('/home/svcapp/userdata/emotion_data/emotion/', save=False)
...
pair_set.feature_stats = load_dat('dataset_section_tempo/stat.dat')['stats']
pair_set.save_features_for_virtuosoNet('dataset_emotion_section_tempo/', update_stats=False)
