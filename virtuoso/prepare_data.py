...
dataset = data_class.EmotionDataset('/home/svcapp/userdata/emotion_data/emotion/', save=True)
...
pair_set.feature_stats = load_dat('dataset/stat.dat')['stats']
pair_set.save_features_for_virtuosoNet('dataset_emotion/', update_stats=False)
